                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-sm font-weight-bold text-danger text-uppercase mb-1">
                                                TEMPERATURA</div>
                                            <div class="h1 mb-0 font-weight-bold text-gray-800">25.5°C</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-sm font-weight-bold text-primary text-uppercase mb-1">
                                                WILGOTNOŚĆ</div>
                                            <div class="h1 mb-0 font-weight-bold text-gray-800">64.6 %</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-sm font-weight-bold text-success text-uppercase mb-1">
                                                CIŚNIENIE</div>
                                            <div class="h1 mb-0 font-weight-bold text-gray-800">1104 hPa</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-sm font-weight-bold text-info text-uppercase mb-1">
                                                Status systemu</div>
                                            <div class="h1 mb-0 font-weight-bold text-gray-800">Brak błędów</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-dark">Odczyt czujników</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
